...
var data = fetchJSON("../MainPage/map_data.geojson").then(function (data) {
...
/////////////////////////////////////////////////////////////////// diafora admin me user
  function rateButtonInit() {
    ratebtn.innerHTML = "Delete offer";
    ratebtn.id = "rateButton";
    ratebtn.onclick = function () {
      window.location.href = "delete_offer.html";
    };
  }
////////////////////////////////////////////////
  ...
  function offerPopulate() {
    ...
    if (superId != null) {
      ...
      fetch("../MainPage/fetchSupOffers.php", {
        method: "POST",
        headers: {
          ...
          items.forEach((item) => {
            if (item.trim() != "") {
              ...
              dislikeButton.addEventListener("click", () => {
                ...
                fetch("../MainPage/dislikeOffer.php", {
                  method: "POST",
                  headers: {
                    "Content-Type": "application/json",
                  },
  ...
  var catName;
  xhr.open("GET", "../MainPage/fetchCategories.php", true);
      ...
      if (xhr.status === 200) {
        ...
        for (var i = 0; i < response.length; i++) {
          ...
          button.addEventListener("click", function () {
            ...
            fetch("../MainPage/fetchOffers.php", {
              method: "POST",
              headers: {
  ...
  function setAllIcons() {
    fetch("../MainPage/fetchAllOffers.php", {
      method: "POST",
      headers: {
        "Content-Type": "text/plain",
      },
